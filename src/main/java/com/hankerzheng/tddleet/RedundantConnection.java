...
public class RedundantConnection {
     ...
     * MY THOUGHTS:
     *
     * One graph cannot convert to a tree if and only if there is a cycle in it.
     * Therefore, all we need to do is to check is, after each edge added into the graph,
     * whether there is a cycle in the graph. If so, return the edge that makes the cycle.
     *
     *
     * Time Complexity: O(n)
